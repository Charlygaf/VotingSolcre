      ...
      <TooltipProvider>
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Las cédulas de identidad deben ser válidas y no haber votado
              previamente.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-1">
                <Label htmlFor="voterId" style={{ fontFamily: "Open Sans" }}>
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <InfoIcon width={13} strokeWidth={2} height={13} />
                    </TooltipTrigger>
                    <TooltipContent className="bg-white text-black p-5">
                      <p className="text-sm">
                        El seeder contiene cédulas de identidad con el formato:
                        DOC + un digito del 1 al 10
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </Label>
